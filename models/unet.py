...
from .modules.utils import normalization, conv_nd, checkpoint, zero_module
from .modules.attention import AttentionBlock, Pool2dAttention, SpatialTransformer
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, y=None, context=None):
        """
